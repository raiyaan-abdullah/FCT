...
class VisdroneEvaluator(DatasetEvaluator):
    ...
    def evaluate(self):
        ...
        if len(predictions) == 0:
            self._logger.warning("[VisdroneEvaluator] Did not receive valid predictions.")
            return {}
    ...
    def _eval_predictions(self, tasks, predictions):
        ...
        if self._output_dir:
            file_path = os.path.join(self._output_dir, "visdrone_instances_results.json")
...
def _evaluate_predictions_on_coco(coco_gt, coco_results, iou_type, kpt_oks_sigmas=None):
    ...
    if iou_type == "keypoints":
        ...
        assert num_keypoints_oks == num_keypoints_dt == num_keypoints_gt, (
            f"[VisdroneEvaluator] Prediction contain {num_keypoints_dt} keypoints. "
