...
class FsodRCNN(nn.Module):
    ...
    def init_model_visdrone(self):
        if 1:
            if self.keepclasses == 'all':
                if self.test_seeds == 0:
                    support_path = './datasets/visdrone/full_class_{}_shot_support_df.pkl'.format(self.evaluation_shot)
                elif self.test_seeds > 0:
                    support_path = './datasets/visdrone/seed{}/full_class_{}_shot_support_df.pkl'.format(self.test_seeds, self.evaluation_shot)
            else:
                if self.test_seeds == 0:
                    support_path = './datasets/visdrone/{}_shot_support_df.pkl'.format(self.evaluation_shot)
                elif self.test_seeds > 0:
                    support_path = './datasets/visdrone/seed{}/{}_shot_support_df.pkl'.format(self.test_seeds, self.evaluation_shot)
