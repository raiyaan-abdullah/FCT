...
class DAnARCNN(nn.Module):
    ...
    def __init__(self, classes, rpn_reduce_dim, gamma, semantic_enhance, n_way=2, n_shot=5, pos_encoding=True):
    ...
    def forward(self, im_data, support_ims, all_cls_gt_boxes=None):
        ...
        for i in range(self.n_shot):
            ...
            dense_support_feature += [support_adaptive_attention_feature] # QPA vectors
