...
def _get_visdrone_fewshot_instances_meta():
    ret = {
        "thing_classes": VISDRONE_CATEGORIES,
        "novel_classes": VISDRONE_NOVEL_CATEGORIES,
        "base_classes": VISDRONE_BASE_CATEGORIES,
    }
    return ret
...
def _get_builtin_metadata_visdrone(dataset_name):
