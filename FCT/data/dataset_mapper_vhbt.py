            ...
            if self.few_shot:
                if 'full' in cfg.DATASETS.TRAIN[0]:
                    if self.seeds == 0:
                        ...
                        self.support_df = pd.read_pickle("./datasets/vhbt/seed{}/full_class_{}_shot_support_df.pkl".format(self.seeds, cfg.INPUT.FS.SUPPORT_SHOT))
                        print("training support_df=", "./datasets/vhbt/seed{}/full_class_{}_shot_support_df.pkl".format(self.seeds, cfg.INPUT.FS.SUPPORT_SHOT))
                else:
                    if self.seeds == 0:
                        ...
                        self.support_df = pd.read_pickle("./datasets/vhbt/seed{}/{}_shot_support_df.pkl".format(self.seeds, cfg.INPUT.FS.SUPPORT_SHOT))
                        print("training support_df=", "./datasets/vhbt/seed{}/{}_shot_support_df.pkl".format(self.seeds, cfg.INPUT.FS.SUPPORT_SHOT))
            else:
